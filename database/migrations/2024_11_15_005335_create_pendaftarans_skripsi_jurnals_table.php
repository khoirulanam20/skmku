...
return new class extends Migration
{
    ...
    {
        Schema::create('pendaftarans_skripsi_jurnals', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('ss_reputasi_jurnal_sinta')->nullable();
            $table->string('bukti_publikasi')->nullable();
            $table->string('bukti_koreapondensi')->nullable();
    ...
    {
        Schema::dropIfExists('pendaftarans_skripsi_jurnals');
    }
};
