...
<body class="bg-login">
    ...
    <img src="{{ asset('env') }}/udinus.png" width="250" alt="Logo SkripsiKU" class="img-fluid">
    <p class="mt-3">
        Selamat datang di <strong>SkripsiKU</strong>, sistem informasi yang dirancang untuk memudahkan pengelolaan skripsi bagi mahasiswa dan dosen. 
