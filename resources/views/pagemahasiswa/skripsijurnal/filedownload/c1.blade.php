        ...
        <div class="col-12">
            ...
            <table class="table">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td style="width: 20px;">:</td>
                        <td class="">{{ $pendaftaranskripsijurnal->judul_skripsi }}</td>
                    </tr>
                </table>
            ...
            <table class="table">
                <tr>
                    ...
                    <td style="width: 20px;">:</td>
                    <td class="">{{ $pendaftaranskripsijurnal->tanggal }}</td>
                </tr>
                <tr>
                    <td style="width: 200px;">Jam</td>
                    <td style="width: 20px;">:</td>
                    <td class="">{{ $pendaftaranskripsijurnal->waktu }}</td>
                </tr>
                <tr>
                    <td style="width: 200px;">Lokasi</td>
                    <td style="width: 20px;">:</td>
                    <td class="">{{ $pendaftaranskripsijurnal->tempat }}</td>
                </tr>
            </table>
            ...
            <table class="table table-bordered text-center">
                ...
                <tr>
                    ...
                    <td class="">{{ $pendaftaranskripsijurnal->dosenketuapenguji->nama }}</td>
                    <td class="">{{ $pendaftaranskripsijurnal->dosenpenguji->nama }}</td>
                    <td class="">{{ $pendaftaranskripsijurnal->dosenpembimbing->nama }}</td>
                </tr>
            </table>
