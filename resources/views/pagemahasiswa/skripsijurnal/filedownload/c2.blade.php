...
<body>
    <div class="header">
        <img alt="University logo" src="{{ asset('env') }}/udinus.png" />
        <div>
    ...
    <div class="info mb-5">
        ...
        <p><span>Judul Skripsi</span> : {{ $pendaftaranskripsijurnal->judul_skripsi }}</p>
    </div>
    ...
    <div class="signature">
        ...
        <p>{{ $pendaftaranskripsijurnal->dosenpenguji->nama }}</p>
    </div>
    ...
    <div class="signature">
        ...
        <p>{{ $pendaftaranskripsijurnal->dosenpembimbing->nama }}</p>
    </div>
    <script>
