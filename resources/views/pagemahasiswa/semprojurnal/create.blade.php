            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Tambah Pendaftaran Sempro Jurnal</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Tambah Pendaftaran Sempro Jurnal</h5>
                        </div>
                        <hr>
                        <form action="{{ route('pendaftaransemprojurnal.store') }}" method="POST" enctype="multipart/form-data" class="row g-3">
                            @csrf
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="file" class="form-control" id="surat_keterangan_layak_etik" name="surat_keterangan_layak_etik" required>
                            </div>
                            <div class="col-md-6">
                                <label for="seminar_proposal" class="form-label">Seminar Proposal</label>
                                <input type="file" class="form-control" id="seminar_proposal" name="seminar_proposal" required>
                            </div>
