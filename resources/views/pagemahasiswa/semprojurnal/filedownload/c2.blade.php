...
<body>
    ...
    <div class="info mb-5">
        ...
        <p><span>Judul Proposal</span> : {{ $pendaftaransemprojurnal->judul_proposal }}</p>
    </div>
    ...
    <div class="signature">
        ...
        <p>{{ $pendaftaransemprojurnal->dosenpembimbing->nama }}</p>
    </div>
    ...
    <div class="signature">
        ...
        <p>{{ $pendaftaransemprojurnal->dosenadvisor->nama }}</p>
    </div>
    <script>
