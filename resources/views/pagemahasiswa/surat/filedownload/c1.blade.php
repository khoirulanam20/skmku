        ...
        <div class="col-12">
            ...
            <table class="table">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td style="width: 20px;">:</td>
                        <td class="">{{ $pendaftaransempro->judul_proposal }}</td>
                    </tr>
                </table>
            ...
            <table class="table">
                <tr>
                    ...
                    <td style="width: 20px;">:</td>
                    <td class="">{{ $pendaftaransempro->tanggal }}</td>
                </tr>
                <tr>
                    <td style="width: 200px;">Jam</td>
                    <td style="width: 20px;">:</td>
                    <td class="">{{ $pendaftaransempro->waktu }}</td>
                </tr>
                <tr>
                    <td style="width: 200px;">Lokasi</td>
                    <td style="width: 20px;">:</td>
                    <td class="">{{ $pendaftaransempro->tempat }}</td>
                </tr>
            </table>
            ...
            <table class="table table-bordered text-center">
                ...
                <tr>
                    ...
                    <td class="">{{ $pendaftaransempro->dosenpembimbing->nama }}</td>
                    <td class="">{{ $pendaftaransempro->dosenadvisor->nama }}</td>
                </tr>
            </table>
