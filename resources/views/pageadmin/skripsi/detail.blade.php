                            ...
                            <form action="{{ route('verifskripsi.update', $pendaftaranskripsi->id) }}" method="POST"
                                    ...
                                    <select class="form-select" id="ketua_penguji_id" name="ketua_penguji_id" required>
                                        @foreach ($dosens as $dosen)
                                            <option value="{{ $dosen->user_id }}"
                                                {{ $pendaftaranskripsi->ketua_penguji_id == $dosen->user_id ? 'selected' : '' }}>
                                                {{ $dosen->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="penguji_id" name="penguji_id" required>
                                        @foreach ($dosens as $dosen)
                                            <option value="{{ $dosen->user_id }}"
                                                {{ $pendaftaranskripsi->penguji_id == $dosen->user_id ? 'selected' : '' }}>
                                                {{ $dosen->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div id="form-diterima" class="row mt-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="time" class="form-control" id="selesai" name="selesai" value="{{ $pendaftaranskripsi->selesai }}"
                                            placeholder="Selesai">
                                    </div>
                                    <div class="col-md-6">
