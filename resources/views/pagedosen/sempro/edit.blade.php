            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Pendaftaran Sempro</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Edit Pendaftaran Sempro</h5>
                        </div>
                        <hr>
                        <form action="{{ route('pendaftaransempro.update', $pendaftaransempro->id) }}" method="POST" enctype="multipart/form-data" class="row g-3">
                            @csrf
                            @method('PUT')
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="judul_proposal" name="judul_proposal" value="{{ $pendaftaransempro->judul_proposal }}" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="pembimbing_id" name="pembimbing_id" required>
                                    ...
                                    <option value="{{ $dosen->user_id }}" {{ $pendaftaransempro->pembimbing_id == $dosen->id ? 'selected' : '' }}>
                                        {{ $dosen->nama }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="advisor_id" name="advisor_id" required>
                                    @foreach($dosens as $dosen)
                                    <option value="{{ $dosen->user_id }}" {{ $pendaftaransempro->advisor_id == $dosen->id ? 'selected' : '' }}>
                                        {{ $dosen->nama }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="penguji_id" name="penguji_id" required>
                                    @foreach($dosens as $dosen)
                                    <option value="{{ $dosen->user_id }}" {{ $pendaftaransempro->penguji_id == $dosen->id ? 'selected' : '' }}>
                                        {{ $dosen->nama }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="{{ asset('dokumen/kartu_bimbingan/' . basename($pendaftaransempro->dokumen_kartu_bimbingan)) }}" target="_blank">Lihat Kartu Bimbingan</a><br>
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="{{ asset('dokumen/kehadiran_seminar_proposal/' . basename($pendaftaransempro->dokumen_kehadiran_seminar_proposal)) }}" target="_blank">Lihat Kehadiran Seminar</a><br>
                            </div>
                            <div class="col-md-6">
                                ...
                                <a href="{{ asset('dokumen/pendaftaran_seminar_proposal/' . basename($pendaftaransempro->dokumen_pendaftaran_seminar_proposal)) }}" target="_blank">Lihat Pendaftaran Seminar</a><br>
                            ...
                            <div class="col-md-6">
                                ...
                                <a href="{{ asset('dokumen/turnitin/' . basename($pendaftaransempro->dokumen_turnitin)) }}" target="_blank">Lihat Turnitin</a><br>
                            </div>
                            <div class="col-md-6">
                                ...
                                <a href="{{ asset('dokumen/draf_proposal/' . basename($pendaftaransempro->draf_proposal)) }}" target="_blank">Lihat Draf Proposal</a><br>
                            </div>
